...
import net.royqh.easypersist.entity.model.jpa.CollectionTable;
import net.royqh.easypersist.entity.model.jpa.Column;
import net.royqh.easypersist.entity.model.jpa.ElementCollection;
import net.royqh.easypersist.entity.model.jpa.Index;
import net.royqh.easypersist.entity.model.jpa.JoinColumn;
import net.royqh.easypersist.entity.model.jpa.JoinTable;
...
import net.royqh.easypersist.entity.model.jpa.OneToOne;
